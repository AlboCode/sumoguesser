...
(function (global) {
  ...
  var STRINGS = {
    en: {
      ...
      heroKicker: "Ten bouts. Four choices each.",
      heroTitle: "Who is this rikishi?",
      heroLede: "Ten wrestlers are drawn at random from the current banzuke. Put a name to each portrait — or a portrait to each name — and earn your rank.",
      chipPool: "rikishi in the pool",
      chipRounds: "rounds",
      chipChoices: "choices",
      modeLabel: "Which way round",
      modeName: "Guess the name",
      modeFace: "Guess the face",
      modeNoteName: "A portrait, and four names to choose from.",
      modeNoteFace: "A name, and four portraits to choose from.",
      ...
      reviewHint: "Tap a bout to see the rikishi's card.",
    ...
    ja: {
      ...
      heroKicker: "十番勝負・四択",
      heroTitle: "この力士は誰か",
      heroLede: "現在の番付から十人の力士を無作為に選びます。写真から四股名を、あるいは四股名から写真を当てて、あなたの番付を手にしてください。",
      chipPool: "人の力士",
      chipRounds: "番",
      chipChoices: "択",
      modeLabel: "出題形式",
      modeName: "四股名を当てる",
      modeFace: "顔を当てる",
      modeNoteName: "写真を見て、四つの四股名から選びます。",
      modeNoteFace: "四股名を見て、四つの写真から選びます。",
      divisionLabel: "階級",
      divAll: "関取すべて",
      divMakuuchi: "幕内",
      divJuryo: "十両",
